...
| Method | Import |
|---|---|
| Dissimilarity + Beam Search | `from lm_polygraph.estimators import DissimilarityBeamsearch` |
| Eccentricity + Beam Search | `from lm_polygraph.estimators import EccentricityConfBeamsearch` |
| EigVecDissimilarity + Beam Search | `from lm_polygraph.estimators import EigVecDissimilarityBeamsearch` |
| CoCoA + Beam Search | `from lm_polygraph.estimators import CocoaMSPBeamsearch, CocoaPPLBeamsearch, CocoaMTEBeamsearch` |
