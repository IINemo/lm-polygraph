...
class SemanticClassesCalculator(StatCalculator):
    ...
    def __call__(
        ...
        self._is_entailment = (
            dependencies[self.classes_key] == dependencies["entailment_id"]
        )
...
class InputOutputSemanticClassesCalculator(SemanticClassesCalculator):
    def __init__(self):
        ...
        self.return_key = "input_output_semantic_classes_entail"

        super().__init__(
            [
                "input_output_semantic_classes_entail",
            ],
            [
                self.classes_key,
                "sample_texts",
...
class OutputSemanticClassesCalculator(SemanticClassesCalculator):
    def __init__(self):
        self.classes_key = "semantic_matrix_classes"
        self.return_key = "semantic_classes_entail"
