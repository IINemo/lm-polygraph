...
class CrossEncoderTokenSimilarityCalculator(StatCalculator):
    """
    Calculates the cross-encoder token similarity for greedy generation only.
    """
...
class CrossEncoderSampleSimilarityCalculator(StatCalculator):
    """
    Calculates the cross-encoder similarity matrix and per-token similarity
    for sampled generations.
    """
    ...
    def __call__(
        ...
        # Sentence-level similarity matrix over sampled outputs
        batch_pairs = []
        batch_invs = []
        batch_counts = []
        ...
        # Token-level similarity for each sampled output
