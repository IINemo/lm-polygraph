...
class NormalizedSequenceProbability(Estimator):
    """
    Estimates the sequence-level uncertainty of a language model by calculating the
    normalized log-probability of the generation with minus sign.
    It is calculated as the average of log-probabilities of each token.
    Works only with whitebox models (initialized using lm_polygraph.utils.model.WhiteboxModel).
    """
    ...
    def __str__(self):
        return "NormalizedSequenceProbability"
