...
from transformers import AutoConfig, AutoTokenizer, BertForPreTraining, BertModel, RobertaModel, AlbertModel, AlbertForMaskedLM, RobertaForMaskedLM
import torch
...
class BERTAlignModel(nn.Module):
    def __init__(self, model='roberta-large', using_pretrained=True, *args, **kwargs) -> None:
        super().__init__()
