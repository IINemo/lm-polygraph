...
def register_stat_calculators(
    ...
    _register(InputOutputSemanticMatrixCalculator(nli_model=nli_model))
    _register(OutputSemanticMatrixCalculator(nli_model=nli_model))
    _register(InputOutputSemanticClassesCalculator())
    _register(OutputSemanticClassesCalculator())
